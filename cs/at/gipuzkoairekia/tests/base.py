...
def setup_product():
    ...
    import cs.gipuzkoairekia
    zcml.load_config('configure.zcml', cs.gipuzkoairekia)
    ...
    ztc.installPackage('cs.gipuzkoairekia')
...
setup_product()
ptc.setupPloneSite(products=['cs.gipuzkoairekia'])
